...
def main():
    ...
    # Для кожної пари uv (U = 1...N, V = 1...N) ділимо дисперсію U на дисперсію V, або V на U, перевіряючи те,
    #  що дисперсія у чисельнику має буде більше ніж дисперсія у знаменнику
